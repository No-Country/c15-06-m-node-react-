    ...
    return(
        <div className="flex justify-center mt-10 mx-20">
            <div className='mt-16'>
                ...
                <p className="text-2xl font-semibold mt-10">Sumérgete en un mundo de productos cuidadosamente seleccionados para tu bienestar y el del planeta. Siente la diferencia de una elección consciente.</p>
            </div>
            <div>
